...
const BottomNavbar = () => {
  ...
  const valueByDefault = (valueRolDirector, valueRolTeacher) => {
    return usuario?.role === "director" || usuario?.role === "admin"
      ? valueRolDirector
      : valueRolTeacher;
  };
  const [urls] = useState(() => {
        ...
        <div className="w-[90px] h-full">
          ...
          >
            ...
            <p className="text-[12.8px] font-semibold">
              {valueByDefault("Grados", "Mis Grados")}
            </p>
          </button>
        </div>
        <div className="w-[90px] h-full">
          ...
          >
            ...
            <p className="text-[12.8px] font-semibold">
              {valueByDefault("Estudiantes", "Calificar")}
            </p>
          </button>
        </div>
        <div className="w-[90px] h-full">
          ...
          >
            ...
            <p className="text-[12.8px] font-semibold">
              {valueByDefault("Docentes", "Asistencia")}
            </p>
          </button>
        </div>
        <div className="w-[90px] h-full">
