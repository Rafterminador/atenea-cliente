...
const LandingPage = () => {
  ...
  return (
    <>
      <Navbar />
      <div className="mx-16 h-full contenedor flex flex-col justify-between text-center items-center md:grid md:grid-cols-2">
        <div className="bg-[#FCFBFF] bordeblur w-full flex justify-center  md:rounded-[20px] mt-[40px]">
