...
import NewTeachers from "../components/NewTeachers";
      ...
      <main className="">
        ...
        <section className="m-6">
          <div className="flex justify-between">
            ...
            <p className="text-[#776694] text-xs font-bold cursor-pointer">Ver mas</p>
          </div>
          <NewTeachers
            id={1}
        ...
        <section className="m-6">
          ...
          <ActiveTeachers id={1} name="Rubén	Argüero	Sánchez Juanajatoja" grado="Primero Primaria"/>
          <ActiveTeachers id={2} name="Anastasia Madeline Orellana Álvarez" grado="Segundo Primaria"/>
          <ActiveTeachers id={3} name="Sara Josthyn Gutiérrez Lagos" grado="Tercero Primaria"/>
          <ActiveTeachers id={4} name="Baltazar Anais Bustamante Espinoza" grado="Cuarto y Quinto primaria"/>
        </section>
        ...
        <section className="m-6">
          ...
          <InactiveTeachers id={1} name="Rubén	Argüero	Sánchez Juanajatoja" grado="Ningun grado"/>
        </section>
      </main>
